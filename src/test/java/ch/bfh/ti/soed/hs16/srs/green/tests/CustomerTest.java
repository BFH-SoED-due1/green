...
public class CustomerTest {
	...
	public void changeCustumerMailTest() {
		Customer u1 = new Customer("MarcoG", "Marco","Galatioto", "sven@email.ch", "12AB");
	...
	public void changeCustumerNameTest() {
		Customer u1 = new Customer("SvenS", "Sven","Schön", "sven@email.ch", "12AB");
		String name = "Marco";
		u1.setLastname(name);
		assertEquals(name, u1.getLastname());
	}
